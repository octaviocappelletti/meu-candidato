...
export default function RedesSociais({ email, facebook, instagram, twitter, youtube }: Props) {
  const redes: Rede[] = [
    facebook && { label: 'Facebook',   href: facebook,          icon: <IconeFacebook /> },
    instagram && { label: 'Instagram', href: instagram,         icon: <IconeInstagram /> },
    twitter  && { label: 'X / Twitter', href: twitter,          icon: <IconeTwitterX /> },
    youtube  && { label: 'YouTube',    href: youtube,           icon: <IconeYouTube /> },
    email    && { label: 'E-mail',     href: `mailto:${email}`, icon: <IconeEmail /> },
