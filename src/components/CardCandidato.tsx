...
import ResumoAtuacao from './ResumoAtuacao';
...
export default function CardCandidato({ candidato, cargo, uf }: Props) {
  ...
  const temPainel = cargo === 'deputado-federal' || cargo === 'senador';

  return (
    <article className="bg-white rounded-xl border border-gray-200 shadow-sm hover:border-blue-300 hover:shadow-md transition-all overflow-hidden">
      ...
      {temPainel && candidato.nrSequencial && (
        <ResumoAtuacao
